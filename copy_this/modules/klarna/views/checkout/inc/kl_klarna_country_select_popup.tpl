        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title"
                    id="myModalLabel">[{oxmultilang ident="KL_CHOOSE_YOUR_SHIPPING_COUNTRY"}]</h3>
            </div>
            <div class="modal-body">
                ...
                [{*<div class="country-not-on-the-list">
                    <a href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=user&invalidKlarnaCountry=1"}]">[{oxmultilang ident="KL_MY_COUNTRY_IS_NOT_LISTED"}]</a>
                </div>*}]
            </div>
        </div>
    </div>
