    ...
    <div class="drop-container" id="klarnaAddressWidget">
        <div class="drop-trigger">
            <div class="klarna-label">
                ...
                <span class="klarna-address-label"> [{oxmultilang ident="KL_CHOOSE_DELIVERY_ADDRESS"}]
                            </span>
            ...
            <form name="address" action="[{$oViewConf->getSslSelfLink()}]" method="post" role="form">
                ...
                <div class="form-group">
                    <div class="btn-group">
                        <button type="button"
                            ...
                            [{oxmultilang ident="KL_CHOOSE_DELIVERY_ADDRESS"}]</button>
                ...
                <div class="form-group">
                    <button type="submit" id="setDeliveryAddress"
                            class="btn btn-primary">[{oxmultilang ident="KL_USE_AS_DELIVERY_ADDRESS"}]
                    </button>
                </div>
            </form>
        </div>
