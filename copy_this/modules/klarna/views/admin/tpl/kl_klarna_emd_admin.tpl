...
<div class="[{$box|default:'box'}]" style="[{if !$box && !$bottom_buttons}]height: 100%;[{/if}]">
    <div class="main-container">
        ...
        <form name="myedit" id="myedit" method="post" action="[{$oViewConf->getSelfLink()}]"
            ...
            <input type="hidden" name="cl" value="klarna_emd_admin">
            <input type="hidden" name="fnc" value="save">
            <table class="klarna-conf-table">
                <tr class="bg-grey">
                    <td>[{oxmultilang ident="KL_CUSTOMER_ACCOUNT_INFO"}]</td>
                    <td>
                    ...
                    <td>
                        <span class="kl-tooltip" title="[{oxmultilang ident="KL_EMD_CUSTOMER_INFO_TOOLTIP"}]">
                ...
                <tr>
                    <td>[{oxmultilang ident="KL_PAYMENT_HISTORY_FULL"}]</td>
                    <td>
                        <div class="input w356">
                            <div class="display">
                    ...
                    <td>
                        <span class="kl-tooltip" title="[{oxmultilang ident="KL_EMD_PAYMENT_HISTORY_FULL_TOOLTIP"}]">
                            <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                        </span>
                    </td>
                </tr>
                                                ...
                                                <tr class="no-t-border">
                                                    <td colspan="3">
                                                        <table class="inner-table bg-light">
                                                            <tr>
                                                                <td colspan="2"
                                                                    class="conf-label-1">[{oxmultilang ident="KL_ASSIGN_PAYMENT_METHOD_TYPE"}]</td>
                                                                <td>
                                                                    <span class="kl-tooltip"
                                                                          title="[{oxmultilang ident="KL_EMD_PAYMENT_TYPE_TOOLTIP"}]">
                                                            ...
                                                            [{foreach from=$oView->getEmdPaymentTypeOptions() key=sValue item=sLabel name=checkbox}]
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2">
                                                                        <div class="input w356">
                                                                            <input type="radio"
                                                                                   name="payments[[{$payment.oxid}]][oxpayments__klpaymentoption]"
                                                                                   id="radio-[{$sValue}]-[{$payment.oxid}]"
                                                                                   class="radio-custom"
                                                                                   [{if $payment.klpaymentoption == $sValue}]checked="checked"[{/if}]
                                                                                   value="[{$sValue}]"/>
                                                ...
                                                <tr class="no-b-border">
                                                    <td colspan="3">
                                                        <table class="inner-table bg-light">
                                                            <tr>
                                                                <td colspan="2"
                                                                    class="conf-label-1">[{oxmultilang ident="KL_WHICH_ORDERS_IN_FULL_PAYMENT_HISTORY"}]</td>
                                                                <td>
                                                                    <span class="kl-tooltip"
                                                                          title="[{oxmultilang ident="KL_EMD_HISTORY_FULL_TOOLTIP"}]">
                                                                            <i class="fa fa-question fa-lg"
                                                                               aria-hidden="true"></i>
                                                                    </span>
                                                                </td>
                                                            ...
                                                            [{foreach from=$oView->getFullHistoryOrdersOptions() key=sValue item=sLabel name=checkbox}]
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2">
                                                                        <div class="input w356">
                                                                            <input type="radio"
                                                                                   name="payments[[{$payment.oxid}]][oxpayments__klemdpurchasehistoryfull]"
                                                                                   id="radio-[{$sValue}]-[{$payment.oxid}]"
                                                                                   class="radio-custom"
                                                                                   [{if $payment.klemdpurchasehistoryfull == $sValue}]checked="checked"[{/if}]
                                                                                   value="[{$sValue}]"/>
                                                                            <label class="radio-custom-label"
                                                                                   for="radio-[{$sValue}]-[{$payment.oxid}]">
                                                                        </div>
                ...
                <tr class="bg-grey">
                    <td>[{oxmultilang ident="KL_PASSTHROUGH_FIELD"}]</td>
                    <td>
                        <div class="input w356">
                            <div class="display">
                    ...
                    <td>
                        <span class="kl-tooltip" title="[{oxmultilang ident="KL_EMD_PASSTHROUGH_FIELD_TOOLTIP"}]">
                            <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                        </span>
                    </td>
                </tr>
...
<script src="[{ $oViewConf->getKlarnaModuleUrl('out/admin/js/kl_admin_emd.js') }]"></script>