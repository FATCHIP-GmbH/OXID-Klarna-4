...
<tr>
    <td colspan="3" class="inner-table-wrapper">
        <table>
            <tr>
                <td class="conf-label-2">[{ oxmultilang ident="KL_SET_TAC_URI" }]</td>
                <td class="lang-input">
                ...
                <td>
                    <span class="kl-tooltip"
                          title="[{oxmultilang ident="KL_TERMS_AND_CONDITIONS_URL_TOOLTIP"}]">
                        <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                    </span>
                </td>
            </tr>
            <tr>
                <td class="conf-label-2">[{ oxmultilang ident="KL_SET_CANCEL_URI" }]</td>
                <td class="lang-input">
                ...
                <td>
                    <span class="kl-tooltip"
                          title="[{oxmultilang ident="KL_CANCELLATION_RIGHTS_URL_TOOLTIP"}]">
                        <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                    </span>
                </td>
            </tr>
            <tr>
                <td class="conf-label-2">[{ oxmultilang ident="KL_SHIPPING_DETAILS" }]</td>
                <td class="lang-input">
                ...
                <td>
                    <span class="kl-tooltip"
                          title="[{oxmultilang ident="KL_SHIPPING_DETAILS_TOOLTIP"}]">
                        <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                    </span>
                </td>
            </tr>
