...
[{oxscript include=$oViewConf->getModuleUrl('klarna','out/js/kl_klarna_scripts.js') priority=10 }]
...
[{if $aKlFooter}]
    ...
    <script type="text/javascript">
        function embadKlarnaLogo(content) {
    ...
    [{ oxscript add="embadKlarnaLogo('$klFooterContent');"}]
[{/if}]
