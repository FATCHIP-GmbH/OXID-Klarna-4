    ...
    <div class="main-container">
        ...
        [{if $sslNotSet }]
            ...
            <div class="messagebox danger" style="display: block">
                <strong>[{oxmultilang ident="KL_ERROR_SHOP_SSL_NOT_CONFIGURED"}]</strong>
            </div>
            <br>
        [{/if}]
        [{if $KCOinactive }]
            <br>
            <div class="messagebox danger" style="display: block">
                <strong>[{oxmultilang ident="KL_ERROR_KCO_INACTIVE"}]</strong>
            </div>
            <br>
        [{/if}]
        <form name="myedit" id="myedit" method="post" action="[{$oViewConf->getSelfLink()}]"
            ...
            <table class="klarna-conf-table fix1">
                <tr class="bg-grey">
                    <td>
                        [{oxmultilang ident="KL_DEFAULT_SHOP_COUNTRY"}]:
                    </td>
                    <td>
                    ...
                    <td>
                        <span class="kl-tooltip" title="[{oxmultilang ident="KL_KLARNA_DEFAULT_COUNTRY_TOOLTIP"}]">
                            <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td>[{oxmultilang ident="KL_ALLOW_SEPARATE_SHIPPING_ADDRESS"}]</td>
                    <td>
                    ...
                    <td>
                    <span class="kl-tooltip" title="[{oxmultilang ident="KL_ALLOW_SEPARATE_DELIVERY_ADDRESS_TOOLTIP"}]">
                        <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                    </span>
                    </td>
                </tr>
                ...
                <tr class="bg-grey">
                    ...
                    <td>
                    <span class="kl-tooltip" title="[{oxmultilang ident="KL_MANDATORY_PHONE_TOOLTIP"}]">
                        <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                    </span>
                    </td>
                </tr>
                ...
                <tr>
                    <td>[{oxmultilang ident="KL_DATE_OF_BIRTH_MANDATORY"}]</td>
                    <td>
                        <div class="input w356">
                            <div class="display">
                    ...
                    <td>
                    <span class="kl-tooltip" title="[{oxmultilang ident="KL_MANDATORY_BIRTH_DATE_TOOLTIP"}]">
                        <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                    </span>
                    </td>
                </tr>
                ...
                <tr class="bg-grey">
                    <td>[{oxmultilang ident="KL_ENABLE_AUTOFOCUS"}]</td>
                    <td>
                        <div class="input w356">
                            <div class="display">
                    ...
                    <td>
                    <span class="kl-tooltip" title="[{oxmultilang ident="KL_ENABLE_AUTOFOCUS_TOOLTIP"}]">
                        <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                    </span>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" class="inner-table-wrapper">
                        <table class="inner-table">
                            <tr>
                                <td>[{oxmultilang ident="KL_ADD_A_CUSTOM_CHECKBOX"}]</td>
                                <td></td>
                                <td>
                                    <span class="kl-tooltip" title="[{oxmultilang ident="KL_CHECKBOX_TOOLTIP"}]">
                                        <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                                    </span>
                                </td>
                ...
                <tr class="bg-grey">
                    <td colspan="3" class="inner-table-wrapper">
                        <table class="inner-table">
                            <tr>
                                <td>[{oxmultilang ident="KL_ORDER_VALIDATION"}]</td>
                                <td></td>
                                <td>
                                    <span class="kl-tooltip" title="[{oxmultilang ident="KL_VALIDATION_TOOLTIP" }]">
                                        <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                                    </span>
                                </td>
                            </tr>
                    ...
                    <tr class="bg-grey">
                        <td>
                            ...
                            <div class="text-after-flag">
                                [{oxmultilang ident="KL_SALUTATION_MANDATORY"}]
                            </div>
                        </td>
                        <td>
                            <div class="input w356">
                                <div class="display">
                                    <label class="label toggle kco">
                                        <input type="hidden" name="confbools[blKlarnaSalutationMandatory]" value="0">
                                        <input type="checkbox" name="confbools[blKlarnaSalutationMandatory]" value="1"
                                               [{if ($confbools.blKlarnaSalutationMandatory)}]checked[{/if}] [{ $readonly}]>
                                        <div class="toggle-control"></div>
                                    </label>
                                </div>
                            </div>
                        ...
                        <td>
                        <span class="kl-tooltip" title="[{oxmultilang ident="KL_SALUTATION_MANDATORY_TOOLTIP"}]">
                            <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                        </span>
                        </td>
                    </tr>
                ...
                [{if $blGermanyActive }]
                    ...
                    [{*<div class="text-after-flag">*}]
                    [{*[{oxmultilang ident="KL_ENABLE_DHL_PACKSTATION"}]*}]
                    [{*</div>*}]
                    [{*</td>*}]
                    [{*<td>*}]
                    [{*<div class="input w356">*}]
                    [{*<div class="display">*}]
                    [{*<label class="label toggle kco">*}]
                    [{*<input type="hidden" name="confbools[blKlarnaEnableDHLPackstations]" value="0">*}]
                    [{*<input type="checkbox" name="confbools[blKlarnaEnableDHLPackstations]" value="1"*}]
                    [{*[{if ($confbools.blKlarnaEnableDHLPackstations)}]checked[{/if}] [{ $readonly}]>*}]
                    [{*<div class="toggle-control"></div>*}]
                    [{*</label>*}]
                    [{*</div>*}]
                    [{*</div>*}]
                    [{*</td>*}]
                    [{*<td>*}]
                    [{*<span class="kl-tooltip" title="[{oxmultilang ident="KL_ENABLE_DHL_PACKSTATIONS_TOOLTIP"}]">*}]
                    [{*<i class="fa fa-question fa-lg" aria-hidden="true"></i>*}]
                    [{*</span>*}]
                    [{*</td>*}]
                    [{*</tr>*}]
                [{/if}]
                <tr>
                    <td>[{oxmultilang ident="KL_ENABLE_PRE_FILLING"}]</td>
                    <td>
                        <div class="input w356">
                            <div class="display">
                    ...
                    <td>
                    <span class="kl-tooltip" title="[{oxmultilang ident="KL_ENABLE_PRE_FILLING_TOOLTIP"}]">
                        <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                    </span>
                    </td>
                </tr>
                ...
                [{if $blGermanyActive || $blAustriaActive}]
                    <tr class="bg-grey">
                        <td>
                            ...
                            [{/if}]
                            <div class="text-after-flag">
                                [{oxmultilang ident="KL_ENABLE_PREFILL_NOTIFICATION"}]
                            </div>
                        </td>
                        <td>
                            <div class="input w356">
                        ...
                        <td>
                    <span class="kl-tooltip" title="[{oxmultilang ident="KL_ENABLE_PREFILL_NOTIFICATION_TOOLTIP"}]">
                        <i class="fa fa-question fa-lg" aria-hidden="true"></i>
                    </span>
                        </td>
                    </tr>
                ...
                <tr>
                    <td colspan="3" class="inner-table-wrapper">
                        <table class="mlm5 inner-table">
                            ...
                            [{ include file="kl_lang_spec_conf.tpl" }]
                        </table>
                    </td>
                </tr>
                [{*<tr>*}]
...
<script src="[{ $oViewConf->getKlarnaModuleUrl('out/admin/js/kl_admin_configuration.js') }]"></script>