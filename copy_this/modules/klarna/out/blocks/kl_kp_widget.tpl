...
[{if $oViewConf->isKlarnaPaymentsEnabled() && $oView->loadKlarnaPaymentWidget }]
    ...
    [{ oxscript include=$oViewConf->getModuleUrl('klarna','out/js/klarna_payments_handler.js') }]
    [{ oxscript include="https://x.klarnacdn.net/kp/lib/v1/api.js" }]
    [{ oxstyle include=$oViewConf->getModuleUrl('klarna','out/css/klarna_payments.css') }]
[{/if}]